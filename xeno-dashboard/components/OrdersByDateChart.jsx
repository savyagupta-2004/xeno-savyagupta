...
export default function OrdersByDateChart({
  ...
  const totalOrders = aggregatedData.reduce(
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", gap: "0.5rem" }}>
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: "0.5rem",
              background: chartType === "line" ? "grey" : "#e6e6e6",
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderRadius: "0.5rem",
              background: chartType === "bar" ? "grey" : "#e6e6e6",
      ...
      >
        <strong>Debug:</strong> Raw data: {apiData.length}, Aggregated:{" "}
        {aggregatedData.length}, Loading: {isLoading ? "Yes" : "No"}
      </div>
      ...
      {hasData && (
        ...
        >
          <strong> Real Data:</strong> Showing {aggregatedData.length} days of
          aggregated order data from your Shopify store (combined from{" "}
          {apiData.length} raw entries)
        </div>
      )}
    </div>
  );
