    ...
    try {
        ...
        productData && productData.length > 0
          ? productData
              .map((product) => ({
                ...
                unitsSold:
                  product.unitsSold || Math.floor(Math.random() * 100) + 10,
                inventory:
                  product.inventory || Math.floor(Math.random() * 200) + 50,
      ...
      const totalCustomers =
        customerData && customerData.length > 0
          ? customerData.reduce(
              (sum, period) => sum + (period.newCustomers || 0),
              0
            )
          : 0;
      ...
      const returningCustomers =
        customerData && customerData.length > 0
          ? customerData.reduce(
              (sum, period) => sum + (period.returningCustomers || 0),
              0
            )
          : 0;
      ...
      const totalRevenue =
        salesData && salesData.length > 0
          ? salesData.reduce(
              (sum, period) => sum + (period.grossRevenue || 0),
              0
            )
          : 0;
      ...
      const revenueMetrics = {
        ...
        avgMonthlyGrowth:
          salesData && salesData.length > 1
            ? (((salesData[0]?.netRevenue || 0) -
                (salesData[salesData.length - 1]?.netRevenue || 0)) /
                Math.max(salesData[salesData.length - 1]?.netRevenue || 1, 1)) *
              100
            : 0,
      ...
      const orderStats = {
        ...
        avgOrdersPerDay:
          salesData && salesData.length > 0
            ? totalOrderCount / salesData.length
            : 0,
      };
    ...
    <div style={{ display: "grid", gap: "2rem" }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                borderRadius: "0.5rem",
                background: activeTab === tab.id ? "#555555" : "#f3f4f6",
        ...
        {activeTab === "products" && (
          <div>
            ...
            >
              ...
              <div style={{ fontSize: "0.875rem", color: "#6b7280" }}>
                Total Orders:{" "}
                {formatNumber(analytics.orderStats?.totalOrders || 0)}
              </div>
            </div>
            ...
            {analytics.topProducts && analytics.topProducts.length > 0 ? (
                        ...
                        <td style={{ padding: "0.75rem", textAlign: "center" }}>
                          <span
                            style={{
                              ...
                              fontWeight: "600",
                              background:
                                product.growthRate >= 0 ? "#d1fae5" : "#fee2e2",
                              color:
                                product.growthRate >= 0 ? "#065f46" : "#dc2626",
                            }}
                          >
              ...
              >
                ...
                <p>
                  No product data available. Sync your products to see top
                  performers.
                </p>
              </div>
            )}
                  ...
                  >
                    ...
                    >
                      <div style={{ fontSize: "1.8rem", fontWeight: "700" }}>
                        {
                          analytics.topProducts.filter((p) => p.inventory > 100)
                            .length
                        }
                      </div>
                    ...
                    >
                      <div style={{ fontSize: "1.8rem", fontWeight: "700" }}>
                        {
                          analytics.topProducts.filter(
                            (p) => p.inventory > 50 && p.inventory <= 100
                          ).length
                        }
                      </div>
                      <div style={{ fontSize: "0.85rem", opacity: 0.9 }}>
                    ...
                    >
                      <div style={{ fontSize: "1.8rem", fontWeight: "700" }}>
                        {
                          analytics.topProducts.filter((p) => p.inventory <= 50)
                            .length
                        }
                      </div>
                      <div style={{ fontSize: "0.85rem", opacity: 0.9 }}>
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      {formatCurrency(
                        analytics.customerInsights?.avgOrderValue || 0
                      )}
                    </div>
                  </div>
                  <div>
                    ...
                    >
                      {(analytics.customerInsights?.retentionRate || 0).toFixed(
                        1
                      )}
                      %
                    </div>
      ...
      >
        ...
        <div style={{ marginTop: "0.25rem", fontSize: "0.75rem" }}>
          Generated from {salesData.length} sales periods, {customerData.length}{" "}
          customer periods, and {productData.length} products
        </div>
      </div>
    </div>
  );
